        ...
        steps: [
            {
                ...
                html: '<div><h3>' +
                    ...
                    '</span><br/><span>' +
                    gettextCatalog.getString('Later using roles you can grant or deny access to the different folders of the shared space to users that have the appropiate role to execute or share reports along the shared space.') +
                    '</span></div>',
                width: '500px',
                objectArea: false,
                verticalAlign: 'top',
